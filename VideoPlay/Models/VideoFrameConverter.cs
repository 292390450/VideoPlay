...
namespace VideoPlay.Models
{
    public sealed unsafe class VideoFrameConverter : IDisposable
    {
        ...
        private readonly PixelSize _destinationSize;
        private readonly byte_ptrArray4 _dstData;
        private readonly int_array4 _dstLinesize;
        private readonly SwsContext* _pConvertContext;
        public int BuffSize;
        public VideoFrameConverter(PixelSize sourceSize, AVPixelFormat sourcePixelFormat,
            PixelSize destinationSize, AVPixelFormat destinationPixelFormat)
        {
            ...
            BuffSize = convertedFrameBufferSize;
